...
bool test_verify(bool fast_flag, enum noise_level level) {
    ...
    for (unsigned iter=0; iter <= 1; iter++) {
        ...
        RUN_TEST( sha2_128f_simple, false );
        RUN_TEST( sha2_128s_robust, true );
        RUN_TEST( sha2_128f_robust, false );
        RUN_TEST( shake_128s_simple, true ); 
        RUN_TEST( shake_128f_simple, false );
        RUN_TEST( shake_128s_robust, false );
        RUN_TEST( shake_128f_robust, false );
        ...
        // L3 parameter sets
        RUN_TEST( sha2_192s_simple, true );
        RUN_TEST( sha2_192f_simple, false );
        RUN_TEST( sha2_192s_robust, false );
        RUN_TEST( sha2_192f_robust, false );
        RUN_TEST( shake_192s_simple, false );
        RUN_TEST( shake_192f_simple, false );
        RUN_TEST( shake_192s_robust, false );
        RUN_TEST( shake_192f_robust, false );
        ...
        // L5 parameter sets
        RUN_TEST( sha2_256s_simple, true );
        RUN_TEST( sha2_256f_simple, false );
        RUN_TEST( sha2_256s_robust, false );
        RUN_TEST( sha2_256f_robust, false );
        RUN_TEST( shake_256s_simple, false );
        RUN_TEST( shake_256f_simple, false );
        RUN_TEST( shake_256s_robust, false );
        RUN_TEST( shake_256f_robust, false );
